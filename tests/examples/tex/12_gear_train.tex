...
\begin{tikzpicture}
  ...
  % Draw gears
  \drawgear{(centerA)}{\radiusA}{\teethA}{\angleA}{garnet}
  \drawgear{(centerB)}{\radiusB}{\teethB}{\angleB + \meshOffset}{atlantic}
  ...
  % Rotation indicators
  \draw[->, garnet, thick] ([shift={(120:{\radiusA + 0.6})}]centerA)
    arc (120:60:{\radiusA + 0.6});
  \draw[->, atlantic, thick] ([shift={(60:{\radiusB + 0.6})}]centerB)
