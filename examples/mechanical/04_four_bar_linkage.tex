...
% Parameter: \PARAM (0 to 1, mapped to crank angle = 0 to 360 degrees)
% Render: tikzgif render 31_four_bar_linkage.tex
...
\begin{tikzpicture}
  ...
  \pgfmathsetmacro{\crankAng}{\PARAM * 360}
  ...
  % O2 and O4 labels (before bars so they appear underneath)
  \node[font=\footnotesize\bfseries, black!60, anchor=north]
    at (\Oax, {\Oay - 0.85}) {$O_2$};
  \node[font=\footnotesize\bfseries, black!60, anchor=north]
    at (\Obx, {\Oby - 0.85}) {$O_4$};

  % ====== 5. Crank and rocker bars (vertical) ======
  ...
  % ====== 6. Ground pivot pins (where vertical bars meet triangles) ======
