...
\begin{axis}[
    name=stepax,
    at={(0cm, 2.0cm)}, anchor=north west,
...
% Reset and fix bounding box after pgfplots axis (must come after \end{axis}
% to avoid "Dimension too large" errors from pgfplots corner computation)
\pgfresetboundingbox
\useasboundingbox (-1.8, -4.5) rectangle (13, 4.5);
