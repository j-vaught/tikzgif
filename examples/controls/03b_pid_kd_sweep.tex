% Example 26c: PID Tuning Visualization (Kd Sweep)
% PID step response for G(s) = 1/(s+1), sweeping derivative gain Kd = 0.0 to 3.0
% Parameter: \PARAM (0 to 1, mapped to derivative gain Kd = 0.0 to 3.0)
% Render: tikzgif render 26c_pid_kd_sweep.tex
% Difficulty: advanced
...
\pgfmathsetmacro{\Kp}{2.0}
\pgfmathsetmacro{\Ki}{1.0}
\pgfmathsetmacro{\Kd}{\PARAM * -30.0 + 30.05}
