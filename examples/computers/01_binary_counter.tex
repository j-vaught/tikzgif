...
% Parameter: \PARAM sweeps 0 to 1 (default range), mapped to 0-255
% Render: tikzgif render 05_binary_counter.tex --frames 256
...
\begin{tikzpicture}
  ...
  \pgfmathtruncatemacro{\val}{\PARAM * 255}

  % Title
  \node[font=\large\bfseries] at (4, 2) {Decimal: \val};
