% Example 26b: PID Tuning Visualization (Ki Sweep)
% PID step response for G(s) = 1/(s+1), sweeping integral gain Ki = 0.1 to 4.1
% Parameter: \PARAM (0 to 1, mapped to integral gain Ki = 0.1 to 4.1)
% Render: tikzgif render 26b_pid_ki_sweep.tex
% Difficulty: advanced
...
\pgfmathsetmacro{\Ki}{\PARAM * 4.0 + 0.1}
