...
% Parameter: \PARAM (frequency ratio r = w/w_n, range 0.2..20.0)
% Range: 0.2 to 20.0, recommended 120 frames at 15fps
% Difficulty: advanced
...
% Quadratic+linear blend: base oscillates faster at higher r (higher driving freq)
\pgfmathsetmacro{\rFrac}{(\rNow - 0.2) / 19.8}
\pgfmathsetmacro{\animPhase}{1080*\rFrac + 1800*\rFrac*\rFrac}
