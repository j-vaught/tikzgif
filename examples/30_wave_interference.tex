...
% Parameter: \PARAM (0 to 1, mapped to phase difference = 0 to 2*pi radians)
% Render: tikzgif render 30_wave_interference.tex
% Difficulty: advanced
...
\pgfmathsetmacro{\deltaPhi}{\PARAM * 6.283185}
...
% Fix bounding box for tikzgif (must come after all drawing)
\pgfresetboundingbox
\useasboundingbox (-4.5, -4.2) rectangle (4.8, 3.5);
