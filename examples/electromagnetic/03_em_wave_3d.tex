...
% Parameter: \PARAM (0 to 1, mapped to 0-360 degree phase offset)
% Render: tikzgif render 09_em_wave.tex
% Difficulty: advanced
...
\begin{tikzpicture}[
  ...
  % Fixed bounding box in true page coords (reset 3D transform)
  \begin{scope}[x=1cm, y=1cm]
    \useasboundingbox (-3,-4.5) rectangle (13,5);
  \end{scope}
