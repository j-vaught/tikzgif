...
% Difficulty: advanced
% Features demonstrated: control systems, PID dynamics, gain effects
...
\begin{axis}[
    ...
    ymajorgrids=true, grid style={warmgrey!25},
]
    \addplot[fill=atlantic!60, draw=atlantic] coordinates
