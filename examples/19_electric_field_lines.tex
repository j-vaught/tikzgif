...
% Parameter: \PARAM (0 to 1, mapped to x-coordinate of moving charge = 0.5 to 3.5)
% Render: tikzgif render 19_electric_field_lines.tex
...
\pgfmathsetmacro{\xB}{\PARAM * 3 + 0.5}
