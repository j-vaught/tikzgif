...
% Cross-section of a current loop with field lines scaling with current magnitude.
% Parameter: \PARAM (current I in amperes, range 0.5..5.0)
% Range: 0.5 to 5.0, recommended 30 frames
% Difficulty: intermediate
% Features demonstrated: magnetic field, current loop, dipole, field visualization
