...
% Render. High-quality master, then downscale to a repo-friendly width.
%   tikzgif render examples/geometry/05_epicycle_tracer.tex --frames 120 --quality print --dpi 600 --antialias --antialias-factor 3 --output /tmp/epicycle_hq.gif
%   ffmpeg -i /tmp/epicycle_hq.gif -vf "scale=1200:-1:flags=lanczos,palettegen=stats_mode=full" -y /tmp/pal.png
%   ffmpeg -i /tmp/epicycle_hq.gif -i /tmp/pal.png -lavfi "scale=1200:-1:flags=lanczos[x];[x][1:v]paletteuse=dither=none:diff_mode=rectangle" -y outputs/geometry/05_epicycle_tracer.gif
