...
% Parameter: \PARAM (0 to 1, mapped to frequency ratio f/f0 = 1.0 to 3.0)
% Render: tikzgif render 16_antenna_radiation.tex
% Difficulty: advanced
...
\useasboundingbox (-9,-7.5) rectangle (9,5.5);
\clip (-9,-7.5) rectangle (9,5.5);

% ============================================================
% PARAMETER SETUP
% ============================================================
\pgfmathsetmacro{\freqRatio}{\PARAM * 2 + 1}
