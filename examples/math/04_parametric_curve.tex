...
\begin{scope}[shift={(\amp+1.5, 0)}]
    ...
    \node[font=\tiny, warmgrey, anchor=north] at (0, \amp+0.3) {$y(t)$};
\end{scope}

% Fix bounding box across all frames
\pgfresetboundingbox
\useasboundingbox (-\amp-0.8, -\amp-0.8) rectangle (\amp+2.0, \amp+2.0);
