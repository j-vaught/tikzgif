...
% Parameter: \PARAM (0 to 1, mapped to phase angle wt = 0 to 4*pi)
% Render: tikzgif render 14_heat_equation.tex
% Difficulty: advanced
...
\begin{document}
\begin{tikzpicture}
  \useasboundingbox (-8bp, -16bp) rectangle (310bp, 200bp);
  \pgfmathsetmacro{\wt}{\PARAM * 4 * 3.14159}
