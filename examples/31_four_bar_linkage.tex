...
\begin{tikzpicture}
  ...
  % ====== Trail paths (accumulated from angle 0 to current) ======
  \def\trailA{}
  \def\trailB{}
  ...
  % ====== Linkage bars ======
  % Each bar: dark outline + lighter fill using two overlapping thick lines

  % Rocker: O4 -> B (drawn first, behind coupler)
