...
% Axes
\draw[->, thick, red!70!black]   (0,0,0) -- (2.5,0,0) node[anchor=north east]{$x$};
\draw[->, thick, green!50!black] (0,0,0) -- (0,2.5,0) node[anchor=north west]{$y$};
\draw[->, thick, blue!70!black]  (0,0,0) -- (0,0,2.5) node[anchor=south]{$z$};
...
% Face shading
\fill[blue!15, opacity=0.4] (E) -- (F) -- (G) -- (H) -- cycle;
\fill[red!10, opacity=0.3] (A) -- (B) -- (F) -- (E) -- cycle;
\fill[green!10, opacity=0.3] (B) -- (C) -- (G) -- (F) -- cycle;

% Body diagonal
\draw[dashed, orange!70!black, thin] (A) -- (G);

% Center
\filldraw[red!80!black] (0, 0, 0) circle (2pt);

% Label
\node[anchor=north, font=\footnotesize, fill=white, inner sep=2pt, draw=gray!40]
    at (0, 0, -\s-0.6)
