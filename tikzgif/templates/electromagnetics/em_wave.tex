...
% E-field
\draw[red!80!black, very thick, samples=100, domain=0:\zmax, variable=\z]
...
\foreach \z in {0, 0.5, 1.0, ..., 9.0} {
    ...
    \ifnum\pgfmathresult=1
        \draw[->, red!60!black, thin] (\z, 0, 0) -- (\z, \Eval, 0);
    \fi
}

% B-field
\draw[blue!80!black, very thick, samples=100, domain=0:\zmax, variable=\z]
...
\foreach \z in {0, 0.5, 1.0, ..., 9.0} {
    ...
    \ifnum\pgfmathresult=1
        \draw[->, blue!60!black, thin] (\z, 0, 0) -- (\z, 0, \Bval);
    \fi
}
