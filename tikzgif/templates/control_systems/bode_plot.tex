...
\begin{axis}[
    ...
    grid=both, grid style={gray!20}, thick,
    every axis title/.style={font=\small},
    tick label style={font=\tiny},
    label style={font=\footnotesize},
    xticklabels={},
]
    \addplot[domain=0.1:1000, samples=200, blue!80!black, very thick]
...
\begin{axis}[
    ...
    \addplot[domain=0.1:1000, samples=200, red!70!black, very thick]
